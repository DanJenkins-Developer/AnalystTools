...
## Notes on Formatting
Anytime \t or \n is seen, this is to show the formatting elastic has for the respective object, if you just copy and pasted it, and does not need to be added to get the hotkeys to function properly.
